    ...
    <div className='w-full mt-5 flex justify-between flex-col gap-4'>
        ...
        <div className='flex flex-col gap-2'>
            {subjects.slice(4).map(val => (
                <div onClick={() => router.push(`/dashboard/${val.id}`)} key={val.id} className='bg-[#D2F5FF] cursor-pointer hover:bg-[#798f95] h-14 w-full rounded-sm flex p-2 items-center gap-3'>
