...
const ProfileNavModal = ({name,email,idNumber,course}) => {
  return (
    <div className='w-64 h-72 bg-[#D2F5FF] p-5 z-[1000] text-black flex flex-col gap-3  rounded absolute right-4 top-3'>
          <div className='flex  gap-2'>
                ...
                <div className='flex flex-col justify-center '>
                    ...
                    <span className='text-xs'>{idNumber}</span>
                </div>
            </div>
